  ...
  Future<void> _onRegister() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: result.success ? AppColors.gold : Colors.redAccent,
      ),
    );

    if (result.success) {
      // TODO: Navigator.pushReplacement -> HomeScreen
    }
  }
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            ...
            style: TextStyle(color: AppColors.textGold, fontSize: 14),
          ),
        ],
      ),
    );
